...
import com.sylovestp.firebasetest.testspringrestapp.databinding.FragmentMobileWebViewModeBinding
import com.sylovestp.firebasetest.testspringrestapp.pay.MyWebViewChromeClient
import com.sylovestp.firebasetest.testspringrestapp.pay.MyWebViewClient
...
class MobileWebViewModeFragment : Fragment() {
    ...
    private var binding: FragmentMobileWebViewModeBinding? = null
...
//        Iamport.init(this)
        binding = FragmentMobileWebViewModeBinding.inflate(inflater, container, false)
        createdView = true
        return binding?.root
    }
